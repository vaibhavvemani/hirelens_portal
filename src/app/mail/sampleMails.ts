...
const sampleMails: mail[] = [
  ...
  },
  {
    ...
    category: "Professor",
    to: [
      { studentID: 1001, read: true, starred: false, archived: false },
      { studentID: 1003, read: false, starred: true, archived: true },
      { studentID: 1005, read: true, starred: false, archived: true },
    ],
    subject: "Tuition Payment Reminder",
    message:
      "This is a reminder that your tuition payment for Fall 2023 is due by October 30th.",
  ...
  },
  {
    ...
    message:
      "The book 'Advanced Algorithms' you borrowed is due in 3 days. Please renew or return it.",
  ...
  },
  {
    ...
    to: [{ studentID: 1002,
        read: true,
        starred: false,
        archived: true }, { studentID: 1004,
            read: false,
            starred: true,
            archived: false }],
    subject: "Upcoming Career Fair",
    message:
      "Join us for the annual Career Fair on November 15th. Over 50 companies will be recruiting!",
  ...
  },
  {
    ...
    message:
      "I've received your assignment but it appears to be incomplete. Please check and resubmit.",
  ...
  },
  {
    ...
    category: "HRD",
    to: [
        { studentID: 1003, read: true, starred: false, archived: false },
        { studentID: 1004, read: false, starred: true, archived: false }
    ],
    subject: "Appointment Confirmation",
    message:
      "Your appointment with Dr. Smith is confirmed for October 28th at 2:00 PM.",
  ...
  },
  {
    ...
    message:
      "The university portal will be down for maintenance from 2AM to 4AM on October 30th.",
  ...
  },
  {
    ...
    message:
      "I noticed your excellent work in class. Would you be interested in joining my research team?",
  ...
  },
  {
    ...
    message:
      "You're invited to our annual Halloween party on October 31st at the Student Union!",
  ...
  },
  {
    ...
    message:
      "Your official transcript request has been processed and mailed to the requested address.",
  ...
  },
  {
    ...
    message:
      "Midterm grades have been posted to the portal. Please review them and see me during office hours if you have questions.",
  ...
  },
  {
    ...
    message:
      "You may be eligible for the STEM Excellence Scholarship. Click the link to apply.",
  ...
  },
  {
    ...
    message:
      "Your request to change dorm rooms has been approved. Your new room assignment is West Hall 204.",
  ...
  },
  {
    ...
    message:
      "I noticed you missed the last two classes. Please contact me to discuss how to catch up.",
  ...
  },
  {
    ...
    message:
      "Join us for a networking event with successful alumni from your program on November 20th.",
