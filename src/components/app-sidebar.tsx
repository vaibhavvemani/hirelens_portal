...
import { User2, LayoutDashboard, BookOpen, CodeXml, Mail, FileText, Calendar, MessagesSquare, FileUser, SquareChevronRight, BriefcaseBusiness } from "lucide-react"
...
const sidebarGroups: SidebarGroupType[] = [
    ...
    },
    {
        label: "Community",
        items: [
            { title: "Class Discussions", url: "#", icon: MessagesSquare },
        ],
    },
    {
        label: "Utilities",
